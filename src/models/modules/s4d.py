...
class S4D_Layers(nn.Module):
    ...
    def __init__(
        ...
        super(S4D_Layers, self).__init__()
        ...
        for _ in range(n_blocks):
            self.s4d_blocks.append(S4D(d_model, 
                                       d_state,
                                       dropout=dropout, 
                                       transposed=True, 
                                       lr=min(0.001,lr))
    ...
    def forward(self, x):
        ...
        for layer, norm, dropout in zip(self.s4d_blocks, self.norms, self.dropouts):
